...
- Keeps narrative pacing under the user's control in every mode. Every declared action, direct question, and choice receives its ordinary continuation without requiring special “advance” wording; slow pacing develops meaningful beats instead of splitting an obvious action into artificial waits, thresholds, or repeated permission checks.
