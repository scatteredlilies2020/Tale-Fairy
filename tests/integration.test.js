...
test('manifest identifies the adaptive planning release', () => {
    assert.equal(manifest.version, '0.11.114');
    assert.equal(manifest.js, 'extension/index.js?v=0.11.114');
    assert.equal(manifest.css, 'extension/style.css?v=0.11.114');
    assert.match(source, /from '\.\/analysis\.js\?v=0\.11\.114'/);
    assert.match(source, /from '\.\/state\.js\?v=0\.11\.114'/);
    assert.match(source, /from '\.\/author-board\.js\?v=0\.11\.114'/);
    assert.match(source, /from '\.\/conductor\.js\?v=0\.11\.114'/);
