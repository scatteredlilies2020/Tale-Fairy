...
export const PREPARED_RULE = `Prepare a creative playable middle AND future, not variants of the latest topic. Invent compatible places, people, challenges, encounters, projects, secrets and independent developments without prior mention. Develop concrete intermediate experiences, changes and alternative continuations before distant possibilities. Quiet scenes must not narrow preparation. Give new possibilities independent motives instead of tying every encounter to one investigation. Follow the RP's scale and constraints without genre quotas.
