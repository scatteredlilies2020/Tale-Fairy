...
export const GAME_MASTER_CONTRACT = [
    ...
    'CAUSAL ROLE: Use relevant conditions and conditional preparation, not mandatory beats or history. Preserve open outcomes. The writing model chooses realization and rhythm. Open outcomes do not require NPC indecision; a past pause is not a standing order to wait.',
