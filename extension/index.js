...
import { AnalysisValidationError, applyAnalysis, ANALYSIS_OUTPUT_CONTRACT, ANALYSIS_SCHEMA, buildAnalysisPrompt, extractJson, SYSTEM, validateAnalysisResult } from './analysis.js?v=0.11.143';
import { applyPlannerAuthorLayer, buildPromptPayload, clearState, defaultState, fingerprintMessages, generationRetrySource, isAnalysisSourceCurrent, isGuidanceUsable, isReplacementVerificationCurrent, loadState, returnedReplyMatchesVerification, saveState, STATE_KEY, STATE_VERSION } from './state.js?v=0.11.143';
import { markAssistantTurn, plannerRefreshDecision, withRefreshReason } from './planner-scheduler.js?v=0.11.101';
import { resolveInjectionPlacement } from './injection-placement.js?v=0.11.143';
import { clearPromptManagerInjection, configurePromptManagerInjection } from './prompt-manager-injection.js?v=0.11.143';
import { chatHasCurrentGuidance, ensureGuidanceInChat, ensureGuidanceInText, extractTaleFairyContext, requestContainsMarker, textHasCurrentGuidance } from './request-injection.js?v=0.11.143';
import { normalizeModelListResponse } from './models.js?v=0.11.143';
...
import { readContinuityBridge, waitForContinuityBridge } from './continuity.js?v=0.11.143';
import { isPlannerTimeoutError, plannerRetryDelay, shouldRetryPlannerError } from './retry-policy.js?v=0.11.143';
import { collectSummarySources, summarySourceAudit } from './summary-context.js?v=0.11.143';
import { estimateTokenCount } from './token-budget.js?v=0.11.143';
import { completionText } from './completion-response.js?v=0.11.143';
import { sampleDirectorSignals } from './director-sampling.js?v=0.11.143';
...
import { exceedsAppendAllowance, mergePlannerIntents, normalizePlannerIntent } from './planner-coalescer.js?v=0.11.143';

const EXTENSION_ID = 'living-world-guide';
const RUNTIME_VERSION = '0.11.143';
