...
import { isStoryGeneration, refreshGameMasterContract } from './game-master.js?v=0.14.6';
import { selectSituationalOpenings } from './situations.js?v=0.13.9';
import { DEFAULT_REFRESH_INTERVAL, markAssistantTurn, normalizePlannerSchedule, plannerPassDecision, plannerRefreshDecision, withRefreshReason } from './planner-scheduler.js?v=0.14.6';
...
import { chatHasCurrentGuidance, ensureGuidanceInChat, ensureGuidanceInText, extractTaleFairyContext, requestContainsMarker, textHasCurrentGuidance } from './request-injection.js?v=0.14.6';
...
import { DEFAULT_ROUTINE_INPUT, DEFAULT_REVIEW_INPUT, normalizeInputBudget, plannerBudgets } from './planner-budgets.js?v=0.14.6';
import { relevantActors } from './evidence-selection.js?v=0.13.9';
import { completionText } from './completion-response.js?v=0.14.6';
...
import { hasUsableCausalContext } from './causal-context.js?v=0.14.6';
import { formatHiddenMotives } from './scratchpad-format.js?v=0.13.9';
import { WORLD_PLANNER_SYSTEM, WORLD_PLANNER_SCHEMA } from './world-planner.js?v=0.14.6';
import { buildWorldPlannerPrompt } from './analysis.js?v=0.14.6';
...
import { canRetainSuccessfulPlan, createSafetyFallbackState } from './fallback-direction.js?v=0.14.6';
...
async function reevaluateGuideState() {
    ...
    if (replacement) metadata[REPLACEMENT_PENDING_KEY] = { ...metadata[REPLACEMENT_PENDING_KEY],
        repairAttemptedKey: plotInputKey(chatId, messages, generationInputs(context, state)) };
