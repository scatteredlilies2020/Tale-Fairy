...
export function formatBeatContract(_sceneValue, beatValue, options = {}) {
    ...
    return [
        ...
        'SELF-PROPELLING MOVEMENT: The selected branch must produce an observable external development that exists independently of any player reply. Realize it through a completed NPC decision, reaction, action, disclosure, commitment, consequence, discovery, opportunity, environmental change, or task-native progress. In dialogue-centered scenes, let the NPC contribute information, position, emotion, decision, or action that changes the situation and leaves the player free to react or continue.',
