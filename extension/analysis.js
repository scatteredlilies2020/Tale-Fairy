import { fingerprintMessages, normalizeState, stateForPrompt } from './state.js?v=0.13.4';
...
import { formatDriftRequest, mergeOffscreenWorld } from './offscreen-world.js?v=0.13.4';
