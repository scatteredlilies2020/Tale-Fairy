...
export const PACING_INSTRUCTION = 'USER-CONTROLLED PACING — Infer the maximum temporal scope authorized by the complete latest user turn: moment, action, activity, scene, or extended. Treat it as a ceiling, not a quota. A narrow action may receive depth without artificial delay; a broad declaration to complete a bounded activity may complete that whole activity without fragmentation, manufactured difficulty, or permission checkpoints, while a specifically named move remains one action. An NPC requesting one move does not by itself require the user to micromanage every later move. Broad authorization delegates low-stakes procedural execution inside that activity, including reasonable tactics consistent with the user\'s stated approach or competence, but never delegates consequential choices, dialogue, feelings, or a new activity. When the bounded activity is the focus, show its actual evolving substance through concrete representative beats and reach any authorized result; do not replace it with a generic summary or repeatedly stop for trivial input. Allocate attention by current user engagement and narrative yield: protect emotionally rich, relational, revelatory, conflict, discovery, and consequential beats from premature summary or transition, while compressing repetitive procedure, confirmation, travel, and option menus unless the user focuses them. Do not manufacture a question merely to hand the turn back. Routine life may remain routine, but it is not a reason for NPCs, institutions, relationships, or the wider world to become inert. The world may act inside the authorized scope through either an established process or a freshly invented context-compatible cause. Mode changes narrative pressure, boldness, and breadth of possibilities—not speed. Never invent undelegated player decisions or cross the endpoint they authorized.';
...
const PROMPT_PACING_INSTRUCTION = 'USER-CONTROLLED PACING — Infer the latest user turn’s maximum scope as moment, action, activity, scene, or extended; it is a ceiling, not a quota. Complete the declared endpoint without permission checkpoints. Travel to a destination permits travel and arrival only, not the activity there. A broad declaration to complete a bounded activity authorizes representative progression across it; a specific move authorizes one action, and an NPC’s request for a move does not narrow a later broad declaration. Broad authorization delegates reasonable low-stakes procedure, not dialogue, feelings, consequential decisions, or another activity. When the activity is the focus, show representative concrete progression—changing state, tactics, counterplay, reversals, and any authorized outcome—instead of a generic summary or stopping after every micro-step. Allocate attention by user engagement and narrative yield: protect emotionally rich, relational, revelatory, conflict, discovery, and consequential beats from premature summary or transition; compress repetitive procedure, confirmation, travel, and option menus unless the user focuses them. Do not create a question merely to hand the turn back. Slow pacing permits depth, not delay; mode changes pressure, not speed. Apply established causes and constraints without inventing undelegated player choices or crossing the endpoint.';
