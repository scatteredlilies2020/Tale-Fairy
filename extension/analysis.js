...
export function buildAnalysisPrompt(messages, state, note = '', bootstrap = {}, options = {}) {
    ...
    const payload = {
        ...
        motive_rule: 'Privately ask why each notable event, acceleration, delay, silence, refusal, coincidence, invitation, or unusual opportunity is happening. hidden_motives has zero to six ranked explanations, strongest evidence first. If established lore, identity, capability, or relationship makes a specific intervention the clearest causal explanation, state it plainly and rank it most-likely even without confirmation; a powerful figure personally summoning an unusually exceptional subject can be the top hypothesis for an expedited meeting. actor names the suspected person, institution, faction, force, or system; explanation states the hypothesis; mechanism explains the observation; evidence and counterevidence cite clues. likelihood distinguishes established, most-likely, likely, possible, wild-card, and contradicted. Keep bold franchise-aware or original possibilities when they fit, but never add a novelty-only wild-card just to make the list entertaining. current_relevance says none, background, supports-beat, or drives-beat; a likely motive is not canon merely because it ranks first. Never add a motive to canon_updates, force a reveal, or expose exact motives to the provider. Explicit user/OOC facts outrank inferred motives.',
...
PRIVATE HIDDEN-MOTIVE BOARD: Maintain zero to six ranked explanations for the notable why: who benefits, what pressure or incentive operates, what capability or secret explains unusual timing, and what alternative fits if the first is wrong. This is open scratchpad space. Put the strongest evidence-based explanation first, then plausible alternatives. When identity, lore, capability, or relationship clues make a concrete intervention most coherent, write it directly and label it most-likely even without confirmation; specificity alone is not a reason to demote it. A wild-card or contradictory foil is optional only when genuinely unsupported, unlikely, or in tension with evidence; never add novelty-only entertainment. Mark likelihood, evidence, counterevidence, mechanism, relevance, and disclosure. Exact names, lore, secrets, hidden actors, and original inventions are allowed because this board is private. It is never canon, scheduled, player-directed, or provider-visible. Explicit user/OOC facts outrank inference. A motive may shape an NPC/world response only as a private hypothesis; do not turn an unsupported motive into fact or reveal it as established.
...
hidden_motives={status,items,audit}; status is none, open, or focused. items has at most 6 ranked private hypotheses, each {id,actor,explanation,likelihood,evidence,counterevidence,mechanism,current_relevance,disclosure,change}. likelihood is established, most-likely, likely, possible, wild-card, or contradicted; current_relevance is none, background, supports-beat, or drives-beat; disclosure is hidden, signaled, or revealed; change is keep, adjust, replace, or retire. This is open scratchpad space: exact names, secrets, lore, original, unlikely, and contradictory explanations are allowed, but each is labeled and never canon solely because it is listed. Keep strongest first, then alternatives. A specific lore-supported hypothesis may be most-likely without confirmation; specificity alone is not a reason to demote it. Hidden motives never enter provider direction or canon. A strong supported motive may shape the external beat indirectly; a weak or novelty-only motive may not be smuggled in as fact.
