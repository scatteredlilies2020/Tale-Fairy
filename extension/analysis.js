...
export const ANALYSIS_SCHEMA_VALUE = {
    ...
    }, required: ['story_frame','scene','objectives','entities','possibilities','note_resolution','ledger','narrative_events','guidance','inject','reason'],
};
