...
export const ANALYSIS_SCHEMA_VALUE = {
    ...
    properties: {
        ...
        next_guides: { type: 'array', minItems: 2, maxItems: 3, items: { type: 'object', additionalProperties: false, properties: {
            id: { type: 'string', maxLength: 100 }, direction: { type: 'string', maxLength: 360 }, use_when: { type: 'string', maxLength: 240 }, drop_when: { type: 'string', maxLength: 240 }, response_bias: { type: 'string', maxLength: 300 }, world_delta: { type: 'string', maxLength: 220 }, origin: { type: 'string', enum: ['established','inferred','original'] }, basis: { type: 'string', maxLength: 180 }, strength: { type: 'string', enum: ['strong','moderate','light'] }, source_pathways: { type: 'array', maxItems: 3, items: { type: 'string', maxLength: 100 } }, reason: { type: 'string', maxLength: 220 },
