...
import { SELECTED_MATERIAL_SCHEMA, validateSelectedMaterial } from './selected-material.js?v=0.14.34';
...
available names optional opportunities and their relevant conditions, NOT a recap of tasks or accomplishments; developing names substantive activities or processes these could support; lasting names the open longer-term possibilities. Each horizon adds substance, not just "this interest can continue" or a longer timescale. All three concern the discoverable surface and its possible reach, never secret actors, motives or causes. Keep unestablished dependencies conditional. subjectIds names all contributors and is not writer-facing.

Several private aims can inform ONE circumstance: combine their subjectIds. Distinct owners do not make separate material when they express the same process. The packet can sustain independent activities without ordering them or writing one paragraph per owner. Select worthwhile experiences, not their prerequisites. Recurring exchange between communities is substance; more approvals are not a substitute. Do not turn completion into another task, scrutiny or dilemma. Success/failure branches script outcomes rather than opening possibilities.

Remove spent portions without forced novelty. Arrival ends the journey premise, not the wider undertaking. An opportunity can matter before acceptance and during another activity without interrupting it. Leave choices, responses and outcomes open. No invented intervening actions, arbitrary restrictions, resolved pending business, named incidental props, dialogue or ordered beats. Ambiguity does not establish additional places, assets or obligations. Proposals are not new canon.
